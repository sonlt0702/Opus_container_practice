...
*@FileName : JooCarrierDBDAOJooCarrierTotalSumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierDBDAOJooCarrierTotalSumRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierDBDAOJooCarrierTotalSumRSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierDBDAOJooCarrierTotalSumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
