...
<%@ page import="com.clt.apps.opus.esm.clv.doutraining2.errmsgmgmt2.event.DouTrn0002Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.douTraining2.ErrMsgMgmt2");
...
<html>
<head>
<title>Error Message Management2</title>
