...
*@FileName : JooCarrierMgmtDBDAOJooCarrierVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierMgmtDBDAOJooCarrierVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierMgmtDBDAOJooCarrierVOUSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierMgmtDBDAOJooCarrierVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
