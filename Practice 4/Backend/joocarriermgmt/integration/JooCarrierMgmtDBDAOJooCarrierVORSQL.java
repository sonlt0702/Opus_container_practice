...
*@FileName : JooCarrierMgmtDBDAOJooCarrierVORSQL.java
...
public class JooCarrierMgmtDBDAOJooCarrierVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierMgmtDBDAOJooCarrierVORSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierMgmtDBDAOJooCarrierVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
