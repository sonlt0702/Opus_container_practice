...
*@FileName : JooCarrierDBDAOJooCarrierDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierDBDAOJooCarrierDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierDBDAOJooCarrierDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierDBDAOJooCarrierDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
