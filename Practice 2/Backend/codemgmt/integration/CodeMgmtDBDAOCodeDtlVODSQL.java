...
*@FileName : CodeMgmtDBDAOCodeDtlVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeDtlVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeDtlVODSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeDtlVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
