...
*@FileName : JooCarrierDBDAOJooCarrierVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierDBDAOJooCarrierVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierDBDAOJooCarrierVORSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierDBDAOJooCarrierVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
