...
*@FileName : CodeMgmtDBDAOCheckDplCodeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCheckDplCodeVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check Duplicate CodeMgmt
	  * </pre>
	  */
	public CodeMgmtDBDAOCheckDplCodeVORSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCheckDplCodeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
