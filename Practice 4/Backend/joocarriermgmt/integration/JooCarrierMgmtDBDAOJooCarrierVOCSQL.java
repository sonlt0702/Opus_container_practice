...
*@FileName : JooCarrierMgmtDBDAOJooCarrierVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierMgmtDBDAOJooCarrierVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierMgmtDBDAOJooCarrierVOCSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierMgmtDBDAOJooCarrierVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
