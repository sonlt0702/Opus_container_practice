...
*@FileName : ErrMsgMgmt2DBDAOErrMsgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgMgmt2DBDAOErrMsgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgMgmt2DBDAOErrMsgVOCSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgMgmt2DBDAOErrMsgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
