...
*@FileName : ErrMsgMgmt2DBDAOErrMsgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgMgmt2DBDAOErrMsgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgMgmt2DBDAOErrMsgVOUSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgMgmt2DBDAOErrMsgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
