...
*@FileName : ErrMsgMgmt2DBDAOErrMsgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgMgmt2DBDAOErrMsgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgMgmt2DBDAOErrMsgVODSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgMgmt2DBDAOErrMsgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
