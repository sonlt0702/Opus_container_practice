...
*@FileName : JooCarrierMgmtDBDAOJooCarrierVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooCarrierMgmtDBDAOJooCarrierVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierMgmtDBDAOJooCarrierVODSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierMgmtDBDAOJooCarrierVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
